...
benchmark.o: benchmark.cpp classes.h libalgebra/libalgebra.h classes.o storm.h storm.o experimental.o experimental.h
	$(CXX) $(CPPFLAGS) -I/home/marcus/CRoaring/include -c -o $@ $<

benchmark: benchmark.o classes.h libalgebra/libalgebra.h classes.o storm.h storm.o experimental.h experimental.o
